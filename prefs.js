...
function buildPrefsWidget() {
    ...
    prefsWidget.attach(labelSeparator1, 0, 1, 1, 1);
    ...
    prefsWidget.attach(toggleSeparator1, 1, 1, 1, 1);
    ...
    prefsWidget.attach(labelSuspend, 0, 2, 1, 1);
    ...
    prefsWidget.attach(toggleSuspend, 1, 2, 1, 1);
    ...
    prefsWidget.attach(labelRestart, 0, 3, 1, 1);
    ...
    prefsWidget.attach(toggleRestart, 1, 3, 1, 1);
    ...
    prefsWidget.attach(labelPower, 0, 4, 1, 1);
    ...
    prefsWidget.attach(togglePower, 1, 4, 1, 1);
    ...
    let labelWarning = new Gtk.Label({
        label: "<b> Note: </b>\n gsettings/dconf schema <b> '/org/gnome/desktop/lockdown' </b> with key <b> 'disable-log-out' </b> will not have any effect if this extension is on.",
